    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classx', models.CharField(max_length=50, null=True, verbose_name='班级')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('time', models.DateTimeField(default=datetime.datetime.now, verbose_name='借阅时间')),
                ('back_time', models.DateTimeField(blank=True, null=True, verbose_name='还书时间')),
                ('books', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='books.Books', verbose_name='书')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='借阅者')),
            ],
            options={
                'verbose_name': '借阅记录',
